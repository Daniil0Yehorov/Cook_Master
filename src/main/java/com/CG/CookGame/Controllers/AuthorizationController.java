...
public class AuthorizationController {
    ...
    private void initData() {
        ...
        Dish Naggetsi = new Dish(3L,"Нагетси","Рецепт: \n" +
                ...
                "самородок\". Ця назва відображає форму страви, що нагадує золоті зливки. ");
        Dish Hachap= new Dish(4L,"Хачапурі","Рецепт: \n" +
                ...
                "щонайменше десять різновидів цієї страви. ");
        Dish Margarit = new Dish(5L,"Маргарита","Рецепт: \n" +
                ...
                "вказали, що історія та назва “Маргарита” вперше прозвучали у 1930-1940-х роках.");
        Dish Peperoni = new Dish(6L,"Пепероні","Рецепт: \n" +
                ...
                "завойовуючи смаки гурманів у кожному куточку земної кулі. ");
        ...
        Dish Kaliphorn = new Dish(8L,"Каліфорнія","Рецепт: \n" +
                ...
                "своєму м’якому смаку та відсутності сирої риби. ");
        ...
        Dish Shuba = new Dish(10L,"Шуба","Рецепт: \n" +
                ...
                "мав символічне значення, виражаючи протест проти політичних настроїв того часу.");
